...
class ClassRoomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $classRoom->light = $request->light;
        $classRoom->fan = $request->fan;
        $classRoom->bench = $request->bench;
        $classRoom->projecter = $request->projecter;
        $classRoom->size = $request->size;
        $classRoom->smart_room = $request->smart_room;
        $classRoom->save();
