...
class SectionController extends Controller
{
    ...
    public function show(Section $section)
    {
        ...
        $data['teachers'] = User::role('Teacher')
            ...
            ->get();
        $data['rows'] = $section->semesterPrograms;
    ...
    {
        // Delete Data
    $associated = $section->studentEnrolls->count();
        if($associated != 0){
    ...
    public function assignSectionSemesterTeacher(Request $request, $id)
    {
        try {
            $section = ProgramSemesterSection::where('id', $id)->first();
