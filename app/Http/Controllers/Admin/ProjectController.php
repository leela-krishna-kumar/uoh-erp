...
class ProjectController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $data['subjects'] = Subject::has('programs')->get();
    ...
    public function store(Request $request)
    {
        ...
        $project->dissertation = $this->uploadMedia($request,'dissertation',$this->path);
        $project->save();
    ...
    public function edit(Project $project)
    {
       ...
       $data['statuses'] = Project::STATUSES;
        ...
        $data['subjects'] = Subject::whereHas('programs', function ($query) use ($project) {
            $query->where('program_id', $project->program_id);
        })->get();
    ...
    public function update(Request $request, Project $project)
    {
      //  dd($request->all());
        ...
        try{
            ...
            // Update Data
            if($project->dissertation == null){
                $project->dissertation = $project->dissertation;
            }else{
                $project->dissertation = $this->updateMedia($request,'dissertation',$this->path, $project);
            }
            $project->title = $request->title;
            $project->description = $request->description;
            $project->project_category_id = $request->project_category_id;
