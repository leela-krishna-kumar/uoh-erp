...
class DesignationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $designation->filled_positions = $request->filled_positions;
        $designation->total_positions = $request->total_positions;
        $designation->save();
    ...
    {
        // Delete Data
        $associated = User::where('designation_id',$designation->id)->first();
        if($associated){
