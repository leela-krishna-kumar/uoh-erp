...
class SubjectMarkingController extends Controller
{
    ...
    {
        // Module Data
        $this->title = trans_choice('module_subject_mark_publish', 1);
    ...
    public function creditHourReport(Request $request)
    {
        //
        $data['title'] = trans_choice('module_credit_hours_report', 1);
        $data['route'] = $this->route;
        $data['view'] = $this->view;
        $data['path'] = $this->path;
        $data['access'] = $this->access;
        ...
        return view($this->view.'.credit-hours-report', $data);
    }
}
