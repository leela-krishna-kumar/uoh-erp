...
class ExpenseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(!empty($request->department_id) || $request->department_id != null){
            $data['selected_department_id'] = $department_id = $request->department_id;
        }
        else{
            $data['selected_department_id'] = $department_id = '0';
        }
        ...
        // Search Filter
        $data['categories'] = ExpenseCategory::where('status', '1')->select('id','title')
                            ->orderBy('title', 'asc')->get();
        $data['departments'] = Department::where('status', '1')->select('id','title')->orderBy('title', 'asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $existExpense = Expense::where('title', $request->title)->first();
        ...
        Toastr::error(__('Duplicate title not allowed'), __('msg_error'));
    }
