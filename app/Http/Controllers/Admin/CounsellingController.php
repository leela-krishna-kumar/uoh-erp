...
class CounsellingController extends Controller
{
    ...
    // public function counsellorReportIndex(Request $request)
    // {
    ...
    // {
    //     //
    //     $data['title'] = trans_choice('module_counsellor_report', 1);
    //     $data['route'] = $this->route;
    //     $data['view'] = $this->view;
    //     $data['path'] = $this->path;
    //     $data['access'] = $this->access;
    ...
    //         if(isset($session)){
    //         $data['rows'] = Student::where('counselled_by', $request->counselled_by)->get();
    //         }
    //     }
    //     else {
    ...
    //     return view('admin.counsellor-report.index', $data);
    // }
    public function counsellorReportIndex(Request $request)
{
    $data['title'] = trans_choice('module_counsellor_report', 1);
    ...
    if (!empty($request->teacher) && $request->teacher != null) {
        ...
        if (isset($session)) {
            $data['rows'] = Student::where('counselled_by', $request->teacher)->get();
        }
    } else {
        $data['selected_staff'] = null;
    }
    ...
    public function assignStudentCreate(Request $request)
    {
        ...
        $data['path'] = $this->path;
        $data['access'] = $this->access;
        $data['teachers'] = User::role('Teacher')
        ...
        return view('admin.assign-student.create', $data);
    }
    ...
    public function assignStudentStore(Request $request)
    {
        ...
        foreach($request->student_id as $key => $student_id){
            ...
            $student->counselled_by = $request->counselled_by;
