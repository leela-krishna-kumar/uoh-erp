...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // try{
            ...
            foreach($documents as $key =>$attach){
             ...
             // payload in qualifications table 
             if(isset($request->payload) && $request->payload != null){
                $qualification = new Qualification();
                 $qualification->payload = $request->payload;
                 $qualification->model_id = $user->id;
                 $qualification->model_type = User::class;
                 $qualification->save();
             }
             // end payload in qualifications table 
            ...
            //  Experience 
                ...
                $experience->form_date = $request->form_date;
                $experience->to_date = $request->to_date;
                $experience->remark = $request->remark;
                $experience->save();
             //  experience_certificates 
                $experience_certificate = new ExperienceCertificate();
                $experience_certificate->model_id = $user->id;
                $experience_certificate->model_type = User::class;
                $experience_certificate->name = $request->name;
                $experience_certificate->certificate_no = $request->certificate_no;
                $experience_certificate->completion_date = $request->completion_date;
                $experience_certificate->experience_remark = $request->experience_remark;
                $experience_certificate->save();
    ...
    { 
        ...
        try{
            ...
            // payload in qualifications table 
            $qualification = Qualification::where('model_id', $user->id)->where('model_type',User::class)->first();
            if( isset( $request->payload) && $request->payload != null){
                 $qualification->payload = $request->payload;
                 $qualification->save();
             }
            ...
            // experience
              ...
              $experience_certificate = ExperienceCertificate::where('model_id',$user->id)->where('model_type',User::class)->first(); 
