...
class ProgramController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $chk_program =  Program::where('title',$request->title)->where('faculty_id',$request->faculty_id)->first();
        if($chk_program){
            Toastr::success(__('Program already exist with this faculty.'), __('msg_error'));
    ...
    public function update(Request $request, Program $program)
    {
        ...
        $chk_program =  Program::where('id','!=',$program->id)->where('title',$request->title)->where('faculty_id',$request->faculty_id)->first();
        if($chk_program){
            Toastr::success(__('Program already exist with this faculty.'), __('msg_error'));
            return redirect()->back();
        }
    ...
    {
        // Delete Data
        $associated = Student::where('program_id',$program->id)->first();
        if($associated){
