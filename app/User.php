...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsTo(Address::class, 'id','model_id')->where('model_type',User::class)->where('is_permanent',1);
    }
    public function presentAddress()
    {
        return $this->belongsTo(Address::class, 'id','model_id')->where('model_type',User::class);
    }
    ...
    public function getFullNameAttribute() {
     ...
     public function getNameAttribute() {
      ...
      /**
       * Get all of the fleets for the User
       *
       * @return \Illuminate\Database\Eloquent\Relations\HasOne
       */
      public function fleet()
      {
          return $this->hasOne(\App\Models\Fleets::class ,'driver_id','id');
      }
}
