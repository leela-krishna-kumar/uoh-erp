<div class="form-group col-md-3">
    ...
    <select required class="form-control faculty" name="faculty" id="faculty">
  ...
  <div class="form-group col-md-3">
    ...
    <select required class="form-control program" name="program" id="program">
          <option value="">{{ __('Select') }}</option>
          @if(isset($programs))
  ...
  <div class="form-group col-md-3">
    ...
    <select required class="form-control session" name="session" id="session">
          <option value="">{{ __('Select') }}</option>
          @if(isset($sessions))
  ...
  {{-- <div class="form-group col-md-3">
    ...
    <select required class="form-control semester" name="semester" id="semester">
          <option value="">{{ __('Select') }}</option>
          @if(isset($semesters))
  ...
  {{-- <div class="form-group col-md-3">
    <label for="section">{{ __('field_section') }} <span>*</span></label>
      <select required class="form-control section" name="section" id="section">
          <option value="">{{ __('Select') }}</option>
          @if(isset($sections))
