                      ...
                      <div class="row">
                        ...
                        $("#student").on('change',function(e){
                         ...
                         <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="fee_register_id" id="fee_register_id" required>
                                <option value="">{{ __('select') }}</option>
                                @foreach( $fee_registers as $fee_register )
                                <option value="{{ $fee_register->id }}" @if(old('fee_register_id') == $fee_register->id) selected @endif>{{ $fee_register->date }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" name="fee_amount" id="fee_amount" value="{{ old('fee_amount') ?? 0 }}" onkeyup="feesCalculator()" required>
