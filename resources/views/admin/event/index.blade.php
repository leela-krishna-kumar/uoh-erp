                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="description" id="description" value="#70c24a" required></textarea>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                              ...
                                              <a href="{{ route('admin.event-user.index',['event_id'=>$row->id])}}" title="Event User">
                                                    <button type="button" class="btn btn-icon btn-success btn-sm">
                                                        <i class="fa-solid fa-users"></i>
                                                    </button>
                                                </a>
                                                 <a href="{{ route('admin.event-announcement.index',['event_id'=>$row->id])}}" title="Event Announcement">
