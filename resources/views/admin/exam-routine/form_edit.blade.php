<div class="form-group col-md-3">
      ...
      <select class="form-control select2 subject{{$row->id}}" onchange="getTeacher({{$row->id}})" name="subject" id="subject" required>
...
<div class="form-group col-md-3">
      ...
      <select class="form-control select2 teacherSelect{{$row->id}}" name="teachers[]"  multiple required>
            @foreach( $subkectTeachers as $teacher )
