                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">Name<span>*</span></label>
                                    <input required type="text" name="name" id="name" class="form-control" value="{{ $row->name }}">
                            ...
                            <div class="form-group col-md-3">
                                <label for="renewal_category_id">Category<span>*</span></label>
                                    <select required class="form-control" name="renewal_category_id" id="renewal_category_id">
                                        ...
                                        <option value="{{$renewal_category->id}}" @if ($row->renewal_category_id == $renewal_category->id) selected @endif>{{ $renewal_category->name }}</option>
                                        @endforeach
                                    </select>
                                <div class="invalid-feedback"> {{ __('field_status') }}
                                </div>
                            ...
                            <div class="form-group col-md-3">
                                <label for="vehicle_id">Vehicle<span>*</span></label>
                                    <select required class="form-control" name="vehicle_id" id="vehicle_id">
                                        ...
                                        <option value="{{$vehicle->id}}"  @if ($row->vehicle_id == $vehicle->id) selected @endif>{{ $vehicle->number }} | {{ $vehicle->type }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group col-md-6">
                                <label for="renewal_date">Renewal Date<span>*</span></label>
                                    <input required type="date" name="renewal_date" id="renewal_date" class="form-control" value="{{ $row->renewal_date }}">
                                <div class="invalid-feedback"> {{ __('renewal_date') }}
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="expiry_date">Expiry Date<span>*</span></label>
                                    <input required type="date" name="expiry_date" id="expiry_date" class="form-control" value="{{$row->expiry_date}}">
                                <div class="invalid-feedback"> {{ __('expiry_date') }}
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="note">Note</label>
                                    <textarea type="text" name="note" id="note" class="form-control">{{ $row->note }}</textarea>
