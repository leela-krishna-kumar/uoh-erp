    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#basic-table3').DataTable();
            $('#basic-table4').DataTable();
        ...
        tinymce.init({
          ...
          $(document).ready(function() {
                ...
                $('.menu-item').each(function() {
                    var menuItemText = $(this).find('.pcoded-mtext').text().toLowerCase();

                    // Check if the menu item exactly matches the search term from the start
                        if (menuItemText.includes(searchTerm)) {
                        // Show the exact matching menu item
                        $(this).removeClass('d-none');
                    } else {
                        // Hide only the specific menu item without affecting its children
                        $(this).addClass('d-none');
                        // Show its submenus
                        $(this).find('.pcoded-submenu').removeClass('d-none');
                    }
                });
            });
