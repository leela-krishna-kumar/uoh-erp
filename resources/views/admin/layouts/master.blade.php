    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-lightblue">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ms-auto">
                <li><span class="top-icon"><a target="_blank" href="{{ route('news-feed.index') }}" title="News Feed"><i class="fas fa-paper-plane"></i></a></span></li>

                @can('student-attendance-create')
                <li><span class="top-icon"><a href="{{ route('admin.student-attendance.index') }}" title="Student Attendance"><i class="fas fa-user-check"></i></a></span></li>
                @endcan
