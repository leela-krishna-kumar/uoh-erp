...
<div class="navbar-content scroll-div ps ps--active-y">
    ...
    <ul class="nav pcoded-inner-navbar">
            ...
            <ul class="pcoded-submenu">
                ...
                @endif">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        @can('bank-view','bank-create','bank-edit','bank-delete')
                            <li class="pcoded-mtext {{ Request::is('admin/student-intake') ? 'active' : '' }}"><a href="{{ route('admin.student-intake.index') }}" class="">Add Intake - Admission</a></li>
                        @endcan
                    </ul>
                </li>
                @endcanany
        ...
        @canany(['student-attendance-action', 'student-attendance-report', 'student-leave-manage-view', 'student-leave-manage-edit'])
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/student-attendance','admin/student-attendance-report*','admin/student-attendance-summary*','admin/student-leave-manage*') ? 'active pcoded-trigger' : '' }}">
            <a href="#!" class="nav-link">
                <span class="pcoded-micon"><i class="fas fa-user-graduate"></i></span>
        ...
        @canany(['student-enroll-single', 'student-enroll-group', 'student-enroll-adddrop', 'student-enroll-complete','student-change-section'])
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu
         @if(Request::is('admin/student/single-enroll*') || Request::is('admin/student/single-enroll*','admin/student/group-enroll*','admin/student/change-section*','admin/student/subject-adddrop*','admin/student/course-complete*'))
            active pcoded-trigger
        @endif">
            ...
            <ul class="pcoded-submenu">
                ...
                @canany(['student-change-section'])
                <li class="pcoded-mtext {{ Request::is('admin/student/change-section*') ? 'active' : '' }}"><a href="{{ route('admin.change.section') }}" class="">Change Section</a></li>
                @endcanany
        ...
        @canany(['approval-submissions-view','approval-submissions-create','approval-submissions-edit','approval-submissions-delete','approval-submissions-show','approval-submissions-category-view','approval-submissions-category-create','approval-submissions-category-edit','approval-submissions-category-delete','student-enroll-alumni'])
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu
        @if(Request::is('admin/approval-submissions*') || Request::is('admin/approval-submissions-category','admin/student/student-alumni*'))
            active pcoded-trigger
        @endif
        ">
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/report*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/report/student-attendence') ? 'active' : '' }}"><a href="{{ route('admin.report.student-attendence') }}" class="">Student Attendence</a></li>
            @endcanany

            @canany(['employee-&-staff-management-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/staff-attendence') ? 'active' : '' }}"><a href="{{ route('admin.report.staff-attendence') }}" class="">Staff Attendence</a></li>
            @endcanany

            @canany(['employee-&-staff-management-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/exam-results') ? 'active' : '' }}"><a href="{{ route('admin.report.exam-results') }}" class="">Exam Results</a></li>
            @endcanany

            @canany(['AdmissionVsIntake-view'])
                <li class="pcoded-mtext {{ Request::is('admin/report/admissionvsintake') ? 'active' : '' }}"><a href="{{ route('admin.report.admissionvsintake') }}" class="">Admission Vs Intake</a></li>
            @endcanany

            @canany(['eamcet-rank-range-view'])
                <li class="pcoded-mtext {{ Request::is('admin/report/eamcet-rank-range') ? 'active' : '' }}"><a href="{{ route('admin.report.eamcet-rank-range') }}" class="">Eamcet Rank Range</a></li>
            @endcanany

            @canany(['seat-types-view'])
                <li class="pcoded-mtext {{ Request::is('admin/report/seat-types') ? 'active' : '' }}"><a href="{{ route('admin.report.seat-types') }}" class="">Seat Types</a></li>
            @endcanany

            @canany(['hostel-occupancy-view'])
            <li class="pcoded-mtext {{ Request::is('admin/report/hostel-occupancy') ? 'active' : '' }}"><a href="{{ route('admin.report.hostel-occupancy') }}" class="">Hostel Occupancy</a></li>
            @endcanany
        ...
        @canany(['feedback-view','feedback-create','feedback-edit','feedback-delete'])
        <li class="pcoded-mtext nav-item menu-item {{ Request::is('admin/feedback') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/fees-student*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/fees-student-quick-received*') ? 'active' : '' }}"><a href="{{ route('admin.fees-student.quick.received') }}" class="">Generate Fee Receipt</a></li>
                        @endcan

                        @can('fees-student-quick-received-bulk')
                        <li class="pcoded-mtext {{ Request::is('admin/fees-student-quick-received-bulk*') ? 'active' : '' }}"><a href="{{ route('admin.fees-student.quick-received-bulk') }}" class="">Generate Fee Receipts (Bulk)</a></li>
                        @endcan
                ...
                @canany(['fees-staff-due', 'fees-staff-quick-assign', 'fees-staff-quick-received', 'fees-staff-report', 'fees-staff-print','fee-register-view','fee-register-create','fee-register-edit','fee-register-delete','fees-master-view', 'fees-master-create'])
                <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/fees-staff*','admin/fee-register*','admin/fees-master*') ? 'active  pcoded-trigger' : '' }}">
                    <a href="#!" class="nav-link">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/fees-staff*') ? 'active pcoded-trigger' : '' }}"><a href="{{ route('admin.fees-staff.index') }}" class="">Fee Dues</a></li>
                        @endcan
        ...
        ">
            ...
            <ul class="pcoded-submenu">
                ...
                @canany(['tax-setting-create', 'tax-setting-view', 'pay-slip-setting-view','leave-type-create', 'leave-type-view','work-shift-type-create', 'work-shift-type-view','designation-create', 'designation-view','department-create', 'department-view'])
                <li class="pcoded-mtext nav-item pcoded-hasmenu
                @if(Request::is('admin/staff/tax-setting*','admin/staff/leave-type*','admin/staff/work-shift-type*','admin/staff/designation*','admin/staff/holiday*','admin/staff/department*') || Request::is('admin/staff/pay-slip-setting*') || Request::is('admin/user/id-card-setting*'))
                active pcoded-trigger
                @endif">
                    <a href="#!" class="nav-link">
                        <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/hostel*','admin.hostel.student-fee-defaulters','admin.hostel.staff-fee-defaulters','admin/hostel/student-gatepass']) ? 'active pcoded-trigger' : '' }}">
            <a href="#!" class="nav-link">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/hostel-student/create') ? 'active' : '' }}"><a href="{{ route('admin.hostel-student.create') }}" class="">Student Allocation</a></li>
                @endcanany
                ...
                {{-- @canany(['view-student-list'])
                <li class="pcoded-mtext {{ Request::is('admin/hostel/student-gatepass*') ? 'active' : '' }}"><a href="{{ route('admin.student-gatepass.index') }}" class="">Gate Pass</a></li>
                @endcanany --}}

                @canany(['student-fee-defaulters', 'student-fee-defaulters'])
                <li class="pcoded-mtext nav-item pcoded-hasmenu
                {{-- @if(Request::is('admin.hostel.student-fee-defaulters*') || Request::is('admin.hostel.staff-fee-defaulters'))admin/hostel/staff-fee-defaulters --}}
                @if(Request::is('admin/hostel/staff-fee-defaulters*') || Request::is('admin/hostel/student-fee-defaulters'))

                active pcoded-trigger
                @endif">
                    <a href="#!" class="nav-link">
                        {{-- <span class="pcoded-mtext">Fee {{ trans_choice('module_report', 2) }}s</span> --}}
        ...
        @endif">
            ...
            <ul class="pcoded-submenu">
                ...
                @endif">
                    <a href="#!" class="nav-link">
                        <span class="pcoded-mtext">Transport Facility Users</span>
                    </a>
                ...
                <li class="pcoded-mtext {{ Request::is('admin/driver-details') ? 'active' : '' }}"><a href="{{ route('admin.driver-details') }}" class="">{{ trans_choice('module_driver', 2) }}</a></li>
                @endcanany

                @canany(['fleet-view','fleet-create','fleet-edit','fleet-delete'])
                <li class="pcoded-mtext {{ Request::is('admin/fleets') ? 'active' : '' }}"><a href="{{ route('admin.fleets.index') }}" class="">{{ trans_choice('assign_module_driver', 2) }}</a></li>
                @endcanany
                ...
                <li class="pcoded-mtext {{ Request::is('admin/renewal') ? 'active' : '' }}"><a href="{{ route('admin.renewal.index') }}" class="">{{ trans_choice('module_renewal', 2) }}</a></li>
                @endcanany

                {{-- @canany(['renewal-create', 'renewal-create'])
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/renewal*') ? 'active pcoded-trigger' : '' }}">
                    <a href="{{ route('admin.renewal.index') }}" class="nav-link">
                ...
                @endif">
                    <a href="#!" class="nav-link">
                        ...
                        <span class="pcoded-mtext">Transportation Fee Reports</span>
                    </a>
                ...
                @endcanany
                  {{--  --}}
                  @canany(['transport-route-create', 'transport-route-view','transport-vehicle-create', 'transport-vehicle-view','transport-vehicle-log-create', 'transport-vehicle-log-view','renewal-create'])
                  <li class="pcoded-mtext nav-item pcoded-hasmenu
                  @if(Request::is('admin/transport-route*','admin/transport-vehicle','admin/transport-vehicle-log','admin/renewal-category'))
                  active pcoded-trigger
                  @endif">
                      <a href="#!" class="nav-link">
                          <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/setting*','admin/address-type*']) ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/translations*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/setting/language*') ? 'active' : '' }}"><a href="{{ route('admin.language.index') }}" class="">Add {{ trans_choice('module_language', 2) }}</a></li>
                @endcanany

                @canany(['translations-view', 'translations-create'])
                <li class="pcoded-mtext {{ Request::is('admin/translations*') ? 'active' : '' }}"><a href="{{ route('admin.translations.index') }}" class="">Create {{ trans_choice('module_translate', 2) }}</a></li>
                @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/academic*') ? 'active pcoded-trigger' : '' }}">
            ...
            {{-- {{ auth()->user()->can('sfdsffsdf') ? 'Yes' : 'No' }} --}}
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/academic/routine-setting*', 'admin/academic/faculty*','admin/academic/program*','admin/academic/batch*','admin/academic/session*','admin/academic/semester*','admin/academic/section*','admin/academic/room*','admin/academic/enroll-subject*','admin/academic/year-book','admin/academic/book-subject','admin/regulation*') ? 'active pcoded-trigger' : '' }}">
                    <a href="#!" class="nav-link">
                        <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
                    </a>
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        @endcanany
                        @canany(['year-book-create', 'year-book-view', 'year-book-edit'])
                        <li class="pcoded-mtext {{ Request::is('admin/academic/year-book') ? 'active' : '' }}"><a href="{{ route('admin.year-book.index') }}" class="">Add {{ trans_choice('module_year_book', 2) }}</a></li>
                        @endcanany
                        ...
                        @can('regulation')
                        <li class="pcoded-mtext {{ Request::is('admin/regulation*') ? 'active' : '' }}"><a href="{{ route('admin.regulation.index') }}" class="">{{ trans_choice('module_regulation', 1) }}</a></li>
                        @endcan
                    </ul>
                </li>
        ...
        @canany(['funded-research-view', 'funded-research-edit', 'funded-research-delete', 'funded-research-action',
        'books-conferences-view', 'books-conferences-create','books-conferences-delete','books-conferences-edit','books-conferences-action',
        'journals-view','journals-create','journals-delete','journals-edit','journals-action',
        'seed-grant-view','seed-grant-create','seed-grant-delete','seed-grant-edit','seed-grant-action',
        'patents-view','patents-create','patents-delete','patents-edit','patents-action',
        'awards-recognition-view','awards-recognition-create','awards-recognition-delete','awards-recognition-edit','awards-recognition-action',
        'workshops-attended-view','workshops-attended-edit','workshops-attended-create','workshops-attended-delete','workshops-attended-action',
        'faculty-achievements-bulk-import-view'])
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/faculty-achievements*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                @can('books-conferences-view', 'books-conferences-create', 'books-conferences-delete','books-conferences-edit','books-conferences-action')
                ...
                @can('journals-view','journals-create','journals-delete','journals-edit','journals-action')
                ...
                @can('seed-grant-view','seed-grant-create','seed-grant-delete','seed-grant-edit','seed-grant-action')
                ...
                @can('funded-research-view', 'funded-research-edit', 'funded-research-delete', 'funded-research-action')
                ...
                @can('patents-view','patents-create','patents-delete','patents-edit','patents-action')
                ...
                @can('awards-recognition-view','awards-recognition-create','awards-recognition-delete','awards-recognition-edit','awards-recognition-action')
                ...
                @can('workshops-attended-view','workshops-attended-edit','workshops-attended-create','workshops-attended-delete','workshops-attended-action')
                <li class="pcoded-mtext {{ Request::is('admin/faculty-achievements/workshops-attended*') ? 'active' : '' }}">
                    <a href="{{ url('admin/faculty-achievements/workshops-attended') }}" class="">{{ trans_choice('workshops_conducted', 2) }}</a>
                </li>
                @endcan
                {{-- @endcanany --}}

                {{-- @can('bulk-import-export-view') --}}
                @can('faculty-achievements-bulk-import-view')
                <li class="pcoded-mtext {{ Request::is('admin/faculty-achievements/bulk-import') ? 'active' : '' }}"><a href="{{ url('admin/faculty-achievements/bulk-import') }}" class="">Bulk Import</a></li>
                @endcan
            </ul>
        </li>
        @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/exam*','admin/exam/credit-hours-report','admin/academic/exam-routine*','admin/transcript*']) ? 'active pcoded-trigger' : '' }}">
            <a href="#!" class="nav-link">
            ...
            {{--
                ...
                @canany(['marksheet-view', 'marksheet-print', 'marksheet-download', 'certificate-view', 'certificate-create', 'certificate-print', 'certificate-download'])
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/transcript/marksheet*','admin/transcript/certificate*') ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/transcript/marksheet*','admin/transcript/certificate*') ? 'active' : '' }}">
                    <a href="#!" class="nav-link">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        {{-- @canany(['marksheet-setting-view', 'certificate-template-view', 'certificate-template-create'])
                        <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/exam/admit-setting*','admin/exam/result-contribution*','admin/exam/exam-type*','admin/exam/grade*']) ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/exam/result-contribution*') ? 'active' : '' }}">
                            <a href="#!" class="nav-link">
                                <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
                            </a>
                            <ul class="pcoded-submenu">
                ...
                @canany(['admit-setting-view', 'result-contribution-view', 'marksheet-setting-view','certificate-template-view', 'certificate-template-create'])
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/exam/admit-setting*','admin/exam/result-contribution*','admin/exam/exam-type*','admin/exam/grade*','admin/transcript/marksheet-setting*','admin/transcript/certificate-template*']) ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/exam/result-contribution*') ? 'active' : '' }}">
                    <a href="#!" class="nav-link">
                        <span class="pcoded-mtext">{{ trans_choice('module_setting', 2) }}</span>
                    </a>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/placement*','admin/placed-student*','admin/placed-student-list']) ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                @endcanany
                @canany(['placement-view', 'placement-create'])
                <li class="pcoded-mtext {{ Request::is('admin/placed-student-list') ? 'active' : '' }}"><a href="{{ route('admin.placed-student.student-list') }}" class="">Placed Students List</a></li>
                @endcanany
        ...
        @endcanany --}}
        @canany(['task-view','task-create','task-edit','task-delete'])
        <li class="pcoded-mtext nav-item menu-item {{ Request::is('admin/task') ? 'active pcoded-trigger' : '' }}">
        ...
        @canany(['assignment-create', 'assignment-view', 'assignment-marking', 'content-create', 'content-view', 'content-type-view', 'content-type-create','student-note-create', 'student-note-view'])
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/download*','admin/student/student-note*') ? 'active pcoded-trigger' : '' }}">
            <a href="#!" class="nav-link">
                <span class="pcoded-micon"><i class="fas fa-newspaper"></i></span>
                {{-- <span class="pcoded-mtext">{{ trans_choice('module_study_material', 2) }}</span> --}}
                <span class="pcoded-mtext">Assignment/Study Material</span>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu @if(Request::is('admin/library*') || Request::is('admin/member/library*')) active pcoded-trigger @endif">
            <a href="#!" class="nav-link">
            ...
            <ul class="pcoded-submenu">
                @canany(['book-issue-return-action', 'book-issue-return-view'])
                    <li class="pcoded-mtext {{ Request::is('admin/library/library-autocheckinout') ? 'active' : '' }}"><a href="{{ route('admin.library-autocheckinout.index') }}" class="">Auto Checkin Checkout</a></li>
                @endcanany

                @canany(['book-issue-return-action', 'book-issue-return-view'])
                    <li class="pcoded-mtext {{ Request::is('admin/library/library-attendence') ? 'active' : '' }}"><a href="{{ route('admin.library-attendence.index') }}" class="">Library Attendence</a></li>
                @endcanany
               ...
               @canany(['book-accordion-create', 'book-accordion-view'])
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/library/book-list','admin/library/book-category*','admin/library-card-setting*']) ? 'active pcoded-trigger' : '' }}">
                    <a href="#!" class="nav-link">
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu
        @if(Request::is('admin/counselling') || Request::is(['admin/counselling*','admin/assign-student/create','admin/counsellor-report/index*']))
        active pcoded-trigger
        @endif">
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/student-achievement*','admin/achievement-category') ? 'active pcoded-trigger' : '' }}">
            <a href="#!" class="nav-link">
                <span class="pcoded-micon"><i class="fa fa-trophy"></i></span>
