    ...
    <ul class="nav pcoded-inner-navbar">
            ...
            <ul class="pcoded-submenu">
                ...
                @endif">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/caste') ? 'active' : '' }}"><a href="{{ route('admin.caste.index') }}" class="">{{ trans_choice('field_caste', 1) }}</a></li>
                        @endcan

                        @canany(['status-type-create', 'status-type-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/admission/status-type*') ? 'active' : '' }}"><a href="{{ route('admin.status-type.index') }}" class="">{{ trans_choice('module_status_type', 2) }}</a></li>
                        @endcanany

                        @can('user-category-view','user-category-create','user-category-edit','user-category-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/user-category') ? 'active' : '' }}"><a href="{{ route('admin.user-category.index') }}" class="">{{ trans_choice('user_category', 1) }}</a></li>
                        @endcan

                        @can('relation-type-view','relation-type-create','relation-type-edit','relation-type-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/relation-type') ? 'active' : '' }}"><a href="{{ route('admin.relation-type.index') }}" class="">{{ trans_choice('relation_type', 1) }}</a></li>
                        @endcan

                        @can('document-type-view','document-type-create','document-type-edit','document-type-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/document-type') ? 'active' : '' }}"><a href="{{ route('admin.document-type.index') }}" class="">{{ trans_choice('document_type', 1) }}</a></li>
                        @endcan

                        @can('mother-tongue-view','mother-tongue-create','mother-tongue-edit','mother-tongue-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/mother-tongue') ? 'active' : '' }}"><a href="{{ route('admin.mother-tongue.index') }}" class="">{{ trans_choice('mother_tongue', 1) }}</a></li>
                        @endcan

                        @can('seat-type-view','seat-type-create','seat-type-edit','seat-type-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/seat-type') ? 'active' : '' }}"><a href="{{ route('admin.seat-type.index') }}" class="">{{ trans_choice('seat_type', 1) }}</a></li>
                        @endcan

                        @can('student-group-view','student-group-create','student-group-edit','student-group-delete')
                        <li class="pcoded-mtext {{ Request::is('admin/student-group') ? 'active' : '' }}"><a href="{{ route('admin.student-group.index') }}" class="">{{ trans_choice('student_group', 1) }}</a></li>
                        @endcan

                        @can('bank-view','bank-create','bank-edit','bank-delete')
                            <li class="pcoded-mtext {{ Request::is('admin/bank') ? 'active' : '' }}"><a href="{{ route('admin.bank.index') }}" class="">{{ trans_choice('field_bank', 1) }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcanany
        ...
        @endif">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/student-report') ? 'active' : '' }}"><a href="{{ route('admin.student-report.index') }}" class="">List</a></li>
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/student-report-category*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/student-report-category*') ? 'active' : '' }}"><a href="{{ route('admin.student-report-category.index') }}" class="">Categories</a></li>
                    </ul>
                </li>
                @endcanany
            </ul>
        ...
        ">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/approval-submissions') ? 'active' : '' }}"><a href="{{ route('admin.approval-submissions.index') }}" class="">List</a></li>
        ...
        @canany(['scholarship-view', 'scholarship-create', 'scholarship-edit', 'scholarship-delete','donor-view', 'donor-create', 'donor-edit', 'donor-delete','scholarship-student-view', 'scholarship-student-create','scholarship-student-edit','scholarship-student-delete'])
            ...
            ">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-mtext {{ Request::is('admin/scholarship') ? 'active' : '' }}"><a href="{{ route('admin.scholarship.index') }}" class="">List</a></li>
                    @endcanany
                    ...
                    <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/donor') ? 'active pcoded-trigger' : '' }}">
                        ...
                        <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/donor') ? 'active' : '' }}"><a href="{{ route('admin.donor.index') }}" class="">{{ trans_choice('module_scholarship_provider', 1) }}</a></li>
                        </ul>
                    </li>
                    @endcanany
                </ul>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/report*') ? 'active pcoded-trigger' : '' }}">
            ...
            @canany(['student-management-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/student-management') ? 'active' : '' }}"><a href="{{ route('admin.report.student-management') }}" class="">Student Management</a></li>
            @endcanany
              @canany(['employee-&-staff-management-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/employee-staff-management') ? 'active' : '' }}"><a href="{{ route('admin.report.employee-staff-management') }}" class="">Employee & Staff Management</a></li>
            @endcanany
            @canany(['fee-payment-tracking-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/fee-payment-tracking') ? 'active' : '' }}"><a href="{{ route('admin.report.fee-payment-tracking') }}" class="">Fee Payment Tracking</a></li>
            @endcanany 
            @canany(['hostel-management-view']) 
                <li class="pcoded-mtext {{ Request::is('admin/report/hostel-management') ? 'active' : '' }}"><a href="{{ route('admin.report.hostel-management') }}" class="">Hostel Management</a></li>
             @endcanany
            ...
            @canany(['id-cards-issue-view'])  
                <li class="pcoded-mtext {{ Request::is('admin/report/id-cards-issue') ? 'active' : '' }}"><a href="{{ route('admin.report.id-cards-issue') }}" class="">ID Cards Issue</a></li>
            @endcanany    
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/grievance*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                @canany(['grievance-view','grievance-create','grievance-edit','grievance-delete'])
                    <li class="pcoded-mtext {{ Request::is('admin/grievance') ? 'active' : '' }}"><a href="{{ route('admin.grievance.index') }}" class="">List</a></li>
                @endcanany
                @canany(['grievance-category-create'])
                    <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/grievance-category') ? 'active pcoded-trigger' : '' }}">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="pcoded-mtext {{ Request::is('admin/grievance-category') ? 'active' : '' }}"><a href="{{ route('admin.grievance-category.index') }}" class="">Categories</a></li>
                        </ul>
                    </li>
                @endcanany
            </ul>
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/fees-student*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/fees-student*') ? 'active pcoded-trigger' : '' }}"><a href="{{ route('admin.fees-student.index') }}" class="">{{ trans_choice('module_fees_due', 1) }}</a></li>
                        @endcan
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/fees-receipt*') ? 'active' : '' }}"><a href="{{ route('admin.fees-receipt.index') }}" class="">{{ trans_choice('module_fees_receipt_setting', 1) }}</a></li>
                        @endcanany

                        @canany(['fees-master-view', 'fees-master-create'])
                        <li class="pcoded-mtext {{ Request::is('admin/fees-type-master*') ? 'active' : '' }}"><a href="{{ route('admin.fees-type-master.index') }}" class="">{{ trans_choice('module_fees_type_master', 1) }}</a></li>
                        @endcanany

                        @canany(['fees-discount-view', 'fees-discount-create'])
                        <li class="pcoded-mtext {{ Request::is('admin/fees-discount*') ? 'active' : '' }}"><a href="{{ route('admin.fees-discount.index') }}" class="">{{ trans_choice('module_fees_discount', 1) }}</a></li>
                        @endcanany

                        @canany([ 'college-bank-view','college-bank-create','college-bank-edit','college-bank-delete'])
                        <li class="pcoded-mtext {{ Request::is('admin/college-bank') ? 'active' : '' }}"><a href="{{ route('admin.college-bank.index') }}" class="">College Bank</a></li>
                        @endcanany
        ...
        ">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/staff/user*') ? 'active' : '' }}"><a href="{{ route('admin.user.index') }}" class="">{{ trans_choice('module_staff', 1) }} {{ __('list') }}</a></li>
                @endcanany
                ...
                <li class="pcoded-mtext {{ Request::is('admin/staff/leave-type*') ? 'active' : '' }}"><a href="{{ route('admin.leave-type.index') }}" class="">{{ trans_choice('module_leave_type', 2) }}</a></li>
                @endcanany

                @canany(['work-shift-type-create', 'work-shift-type-view'])
                <li class="pcoded-mtext {{ Request::is('admin/staff/work-shift-type*') ? 'active' : '' }}"><a href="{{ route('admin.work-shift-type.index') }}" class="">{{ trans_choice('module_work_shift_type', 2) }}</a></li>
                @endcanany

                @canany(['designation-create', 'designation-view'])
                <li class="pcoded-mtext {{ Request::is('admin/staff/designation*') ? 'active' : '' }}"><a href="{{ route('admin.designation.index') }}" class="">{{ trans_choice('module_designation', 2) }}</a></li>
                @endcanany
                 @canany(['holiday-create', 'holiday-view'])
                <li class="pcoded-mtext {{ Request::is('admin/staff/holiday*') ? 'active' : '' }}"><a href="{{ route('admin.holiday.index') }}" class="">{{ trans_choice('module_holiday', 2) }}</a></li>
                @endcanany
                
                @canany(['department-create', 'department-view'])
                <li class="pcoded-mtext {{ Request::is('admin/staff/department*') ? 'active' : '' }}"><a href="{{ route('admin.department.index') }}" class="">{{ trans_choice('module_department', 2) }}</a></li>
                @endcanany
                ...
                @endif">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/staff/pay-slip-setting*') ? 'active' : '' }}"><a href="{{ route('admin.pay-slip-setting.index') }}" class="">{{ trans_choice('module_pay_slip_setting', 1) }}</a></li>
                        @endcan
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/compliance*') ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/compliance-category*') ? 'active' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/compliance-category*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/compliance-category*') ? 'active' : '' }}"><a href="{{ route('admin.compliance-category.index') }}" class="">Categories</a></li>
                    </ul>
                </li>
                @endcanany
            </ul>
        ...
        @endif">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/transport-vehicle-log') ? 'active' : '' }}"><a href="{{ route('admin.transport-vehicle-log.index') }}" class="">{{ trans_choice('module_transport_log_book',1) }}</a></li>
                @endcanany
                ...
                @endif">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/transport-student*') ? 'active' : '' }}"><a href="{{ route('admin.transport-student.index') }}" class="">{{ trans_choice('module_student', 1) }} {{ __('list') }}</a></li>

                        <li class="pcoded-mtext {{ Request::is('admin/transport-staff*') ? 'active' : '' }}"><a href="{{ route('admin.transport-staff.index') }}" class="">{{ trans_choice('module_staff', 1) }} {{ __('list') }}</a></li>
                    </ul>
                </li>
                @endcanany
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/renewal*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/renewal-category') ? 'active' : '' }}"><a href="{{ route('admin.renewal-category.index') }}" class="">Categories</a></li>
                    </ul>
                </li>
                @endcanany
            ...
            <ul class="pcoded-submenu">
                ...
                @endif">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/visit-purpose*') ? 'active' : '' }}"><a href="{{ route('admin.visit-purpose.index') }}" class="">{{ trans_choice('module_visit_purpose', 2) }}</a></li>
                        @endcanany
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/enquiry-source*') ? 'active' : '' }}"><a href="{{ route('admin.enquiry-source.index') }}" class="">{{ trans_choice('module_enquiry_source', 2) }}</a></li>
                        @endcanany

                        @canany(['enquiry-reference-create', 'enquiry-reference-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/enquiry-reference*') ? 'active' : '' }}"><a href="{{ route('admin.enquiry-reference.index') }}" class="">{{ trans_choice('module_enquiry_reference', 2) }}</a></li>
                        @endcanany

                        @canany(['complain-type-create', 'complain-type-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/complain-type*') ? 'active' : '' }}"><a href="{{ route('admin.complain-type.index') }}" class="">{{ trans_choice('module_complain_type', 2) }}</a></li>
                        @endcanany

                        @canany(['complain-source-create', 'complain-source-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/complain-source*') ? 'active' : '' }}"><a href="{{ route('admin.complain-source.index') }}" class="">{{ trans_choice('module_complain_source', 2) }}</a></li>
                        @endcanany

                        @canany(['postal-type-create', 'postal-type-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/postal-type*') ? 'active' : '' }}"><a href="{{ route('admin.postal-type.index') }}" class="">{{ trans_choice('module_postal_type', 2) }}</a></li>
                        @endcanany

                        @canany(['meeting-type-create', 'meeting-type-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/frontdesk/meeting-type*') ? 'active' : '' }}"><a href="{{ route('admin.meeting-type.index') }}" class="">{{ trans_choice('module_meeting_type', 2) }}</a></li>
                        @endcanany
                    </ul>
                </li>
                @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/setting*','admin/address-type*']) ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/translations*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                @can('setting-view')
                <li class="pcoded-mtext {{ Request::is('admin/setting') ? 'active' : '' }}"><a href="{{ route('admin.setting.index') }}" class="">{{ trans_choice('module_general_setting', 1) }}</a></li>
                @endcan

                @canany(['country-view', 'country-create','country-edit','country-delete'])
                <li class="pcoded-mtext {{ Request::is('admin/setting/country*') ? 'active' : '' }}"><a href="{{ route('admin.country.index') }}" class="">{{ trans_choice('module_country', 1) }}</a></li>
                @endcanany
                @canany(['province-view', 'province-create'])
                <li class="pcoded-mtext {{ Request::is('admin/setting/province*') ? 'active' : '' }}"><a href="{{ route('admin.province.index') }}" class="">{{ trans_choice('module_province', 2) }}</a></li>
                @endcanany

                @canany(['district-view', 'district-create'])
                <li class="pcoded-mtext {{ Request::is('admin/setting/district*') ? 'active' : '' }}"><a href="{{ route('admin.district.index') }}" class="">{{ trans_choice('module_district', 2) }}</a></li>
                @endcanany
                ...
                <li class="pcoded-mtext {{ Request::is('admin/translations*') ? 'active' : '' }}"><a href="{{ route('admin.translations.index') }}" class="">{{ trans_choice('module_translate', 2) }}</a></li>
                @endcanany
                ...
                <li class="pcoded-mtext {{ Request::is('admin/address-type') ? 'active' : '' }}"><a href="{{ route('admin.address-type.index') }}" class="">{{ trans_choice('address_type', 1) }}</a></li>
                @endcan
            </ul>
        </li>
        @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item {{ Request::is('admin/profile*') ? 'active' : '' }}">
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/chapter*','admin/topic*']) ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                @canany(['chapter-create','topic-create', 'topic-view','chapter-view'])
                <li class="pcoded-mtext {{ Request::is('admin/chapter*') ? 'active' : '' }}"><a href="{{ route('admin.chapter.index') }}" class="">Chapter</a></li>
                @endcanany
                
                @canany(['program-create', 'program-view','topic-view'])
                <li class="pcoded-mtext {{ Request::is('admin/topic*') ? 'active' : '' }}"><a href="{{ route('admin.topic.index') }}" class="">Topic</a></li>
                @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/placement*']) ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/placement/company') ? 'active' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/placement/company') ? 'active' : '' }}"><a href="{{ route('admin.company.index') }}" class="">Companies</a></li>

                        <li class="pcoded-mtext {{ Request::is('admin/placement/category') ? 'active' : '' }}"><a href="{{ route('admin.category.index') }}"class="" >Category</a></li>
                    </ul>
                </li>
                @endcanany
            </ul>
        ...
        @canany(['project-view','project-create','project-edit','project-delete','project-category-view', 'project-category-create','project-category-edit','project-category-delete'])
            <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/project*','admin/project-category*']) ? 'active pcoded-trigger' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class="pcoded-mtext {{ Request::is('admin/project') ? 'active' : '' }}"><a href="{{ route('admin.project.index') }}" class="">List</a></li>
                    @endcanany
                    ...
                    @can('project-view','project-category-view','project-category-create')
                        <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/project-category*']) ? 'active pcoded-trigger' : '' }} {{ Request::is('admin/exam/result-contribution*') ? 'active' : '' }}">
                            ...
                            <ul class="pcoded-submenu">
                                <li class="pcoded-mtext {{ Request::is('admin/project-category') ? 'active' : '' }}"><a href="{{ route('admin.project-category.index') }}" class="">Categories</a>
                                </li>
                            </ul>
                        </li>
                    @endcan
            ...
            <ul class="pcoded-submenu">
                ...
                @canany(['faq-category-view','faq-category-create'])
                    <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/faq-category') ? 'active pcoded-trigger' : '' }}">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="pcoded-mtext {{ Request::is('admin/faq-category') ? 'active' : '' }}"><a href="{{ route('admin.faq-category.index') }}" class="">Categories</a></li>
                        </ul>
                    </li>
                @endcanany
            </ul>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/communicate*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext {{ Request::is('admin/communicate/event') ? 'active' : '' }}"><a href="{{ route('admin.event.index') }}?start_date={{$start_date}}&end_date={{$end_date}}" class="">{{ trans_choice('module_event', 2) }} {{ __('list') }}</a></li>
                @endcanany
                ...
                <li class="pcoded-mtext {{ Request::is('admin/communicate/notice') ? 'active' : '' }}"><a href="{{ route('admin.notice.index') }}" class="">{{ trans_choice('module_notice', 1) }} {{ __('list') }}</a></li>
                @endcanany
                ...
                @endif">
                    ...
                    @canany(['event-category-view','event-category-create','event-category-edit','event-category-delete'])
                        <li class="pcoded-mtext {{ Request::is('admin/communicate/event-category') ? 'active' : '' }}"><a href="{{ route('admin.event-category.index') }}?start_date={{$start_date}}&end_date={{$end_date}}" class="">Event Categories</a></li>
                    @endcanany  
        ...
        ">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/member/library*') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/member/library-student*') ? 'active' : '' }}"><a href="{{ route('admin.library-student.index') }}" class="">{{ trans_choice('module_student', 1) }} {{ __('list') }}</a></li>
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/library/book-list','admin/library/book-request*','admin/library/book-category*','admin/library-card-setting*']) ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        @canany(['subject-master-create', 'subject-master-view'])
                            <li class="pcoded-mtext {{ Request::is('admin/library/subject-master') ? 'active' : '' }}"><a href="{{ route('admin.subject-master.index') }}" class="">{{ trans_choice('module_subject_master',1)}}</a></li>
                        @endcanany
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/library-card-setting*') ? 'active' : '' }}"><a href="{{ route('admin.library-card-setting.index') }}" class="">{{ trans_choice('module_library_card_setting', 1) }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcanany
        ...
        @endif">
            ...
            <ul class="pcoded-submenu">
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/counsellor-report/index') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/counsellor-report/index*') ? 'active' : '' }}"><a href="{{ route('admin.counsellor-report.index') }}" class="">Counsellor Report</a></li>
                    </ul>
                </li>
                @endcanany
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/counselling-category') ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-mtext {{ Request::is('admin/counselling-category*') ? 'active' : '' }}"><a href="{{ route('admin.counselling-category.index') }}" class="">Categories</a></li>
                    </ul>
                </li>
                @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/student-achievement*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                @canany(['student-achievement-view', 'student-achievement-create','student-achievement-edit'])
                    <li class="pcoded-mtext {{ Request::is('admin/student-achievement') ? 'active' : '' }}"><a href="{{ route('admin.student-achievement.index') }}" class="">List</a></li>
                @endcanany
                @canany(['achievement-category-create','achievement-category-view','achievement-category-edit'])
                    <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is('admin/achievement-category') ? 'active pcoded-trigger' : '' }}">
                        ...
                        <ul class="pcoded-submenu">
                            <li class="pcoded-mtext {{ Request::is('admin/achievement-category') ? 'active' : '' }}"><a href="{{ route('admin.achievement-category.index') }}" class=""> Categories</a></li>
                        </ul>
                    </li>
                @endcanany
            </ul>
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is('admin/fitness*') ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">              
                @canany(['fitness-student-view', 'fitness-student-create','fitness-student-edit','fitness-student-delete'])
                     <li class="pcoded-mtext {{ Request::is('admin/fitness-student') ? 'active' : '' }}"><a href="{{ route('admin.fitness-student.index') }}" class="">Fitness Students</a></li>
                @endcanany
        ...
        <li class="pcoded-mtext nav-item menu-item pcoded-hasmenu {{ Request::is(['admin/ecourse*','admin/esection*','admin/elesson*','admin/test-paper*','admin/question-bank*']) ? 'active pcoded-trigger' : '' }}">
            ...
            <ul class="pcoded-submenu">
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/ecourse*','admin/esection*','admin/elesson*']) ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">  
                        @canany(['ecourse-view'])
                        <li class="pcoded-mtext {{ Request::is('admin/ecourse*') ? 'active' : '' }}"><a href="{{ route('admin.ecourse.index') }}" class="">List</a></li>
                        @endcanany
                ...
                <li class="pcoded-mtext nav-item pcoded-hasmenu {{ Request::is(['admin/test-paper*','admin/question-bank*']) ? 'active pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="pcoded-mtext {{ Request::is('admin/test-paper*') ? 'active' : '' }}"><a href="{{ route('admin.test-paper.index') }}" class="">List</a></li>
                        @endcanany
