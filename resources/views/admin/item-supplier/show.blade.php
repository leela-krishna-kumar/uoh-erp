                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><mark class="text-primary">{{ __('field_contact_person') }}:</mark> {{ $row->contact_person }}</p><hr/>
                                <p><mark class="text-primary">{{ __('field_designation') }}:</mark> {{ $row->designation }}</p><hr/>
                                <p><mark class="text-primary">{{ __('field_contact_person') }} {{ __('field_phone') }}:</mark> {{ $row->contact_person_phone }}</p><hr/>
                                <p><mark class="text-primary">{{ __('field_contact_person') }} {{ __('field_email') }}:</mark> {{ $row->contact_person_email }}</p><hr/>
