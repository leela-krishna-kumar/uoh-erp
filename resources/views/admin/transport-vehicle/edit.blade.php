                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="type" id="type" required>
                            ...
                            <option value="{{$type['label']}}"@if($row->type == $type['label']) selected @endif>{{$type['label']}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="capacity" id="capacity" value="{{ $row->capacity}}" required>
