            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <a href="{{ route('admin.scholarship-student.index',['scholarship_id'=> request()->get('scholarship_id')]) }}" class="btn btn-primary"><i class="fas fa-arrow-left"></i> {{ __('btn_back') }}</a>
