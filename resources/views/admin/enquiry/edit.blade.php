                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" min="0" class="form-control" name="phone" id="phone" value="{{ $row->phone }}">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="status" id="status">
                                <option value="1" @if( $row->status == 1 ) selected @endif>{{ __('status_open') }}</option>
                                <option value="0" @if( $row->status == 0 ) selected @endif>{{ __('status_close') }}</option>
                            </select>
                        </div>
                        <!-- Form End -->
                      </div>
