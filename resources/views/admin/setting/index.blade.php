                    ...
                    <div class="card-block row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="date_format" id="date_format" required>
                                ...
                                <option value="m/d" @if( $row->date_format == 'm/d' ) selected @endif>{{ __('mm/dd') }}</option>
                                <option value="m/d/Y" @if( $row->date_format == 'm/d/Y' ) selected @endif>{{ __('mm/dd/yyyy') }}</option>
                                <option value="Y-m" @if( $row->date_format == 'Y-m' ) selected @endif>{{ __(('yy-mm')) }}</option>
                                <option value="Y-m-d" @if( $row->date_format == 'Y-m-d' ) selected @endif>{{ __('yyy-mm-dd') }}</option>
                                <option value="m-d-Y" @if( $row->date_format == 'm-d-Y' ) selected @endif>{{ __('mm-dd-yyyy') }}</option>
                                <option value="d/m/Y" @if( $row->date_format == 'd/m/Y' ) selected @endif>{{ __('dd/mm/yyyy') }}</option>
                                <option value="d-m-Y" @if( $row->date_format == 'd-m-Y' ) selected @endif>{{ __('dd-mm-yyyy') }}</option>
                            </select>
                        ...
                        <div class="form-group col-md-4">
                          <label for="due_date_tolerence">{{ __('field_due_date_tolerence') }}<span>*</span>(Library Issue Date) </label>
                          <input type="text" class="form-control" name="due_date_tolerence" id="due_date_tolerence" value="{{ isset($row->due_date_tolerence)?$row->due_date_tolerence:'' }}" required>

                          <div class="invalid-feedback">
                            {{ __('required_field') }} {{ __('field_due_date_tolerence') }}
                          </div>
                        </div>
