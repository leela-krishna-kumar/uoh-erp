                              ...
                              <div class="col-md-12">
                                <fieldset class="row scheduler-border">
                                  <div class="form-group col-md-6">
                                      <label for="model_type">{{ __('Model') }} <span>*</span></label>
                                      <input type="text" class="form-control" name="model_type" id="model_type" value="" required>
                                      <div class="invalid-feedback">
                                        {{ __('required_field') }} {{ __('model_type') }}
                                      </div>
                                  </div>
                                  <div class="form-group col-md-6">
                                    <label for="type">{{ __('field_type') }}</label>
                                        <select class="form-control" name="type" id="type">
                                            ...
                                            <option value="{{$key}}" @if( $key == 1 ) selected @endif>{{ $type['label'] }}</option>
                                            @endforeach
                                        </select>
