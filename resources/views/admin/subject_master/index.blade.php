                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="title" class="form-label">{{trans_choice('module_subject_Name',1) }} <span>*</span></label>
                                <input type="text" class="form-control" name="subject" id="subject" value="{{ old('subject') }}" required>
                              
                                <div class="invalid-feedback">
                                  {{ __('required_field') }} {{ __('Subject Name') }}
                                </div>
                            </div>                          
                            <!-- Form End -->
                        </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                         <th></th>
                                         <th></th>
                                        <th>{{trans_choice('module_subject_Name',1) }}</th>
                                        <th></th>
                                        <th></th>
