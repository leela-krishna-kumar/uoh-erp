                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox d-inline">
                                    ...
                                    <label for="program-{{ $key }}" class="cr">{{ $program->faculty->shortcode }} / {{ $program->title }}</label>
                                </div>
                                @endforeach
                                  ...
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-primary">{{ $program->faculty->shortcode }} / {{ $program->title }}</span><br>
                                            @endforeach
                                        </td>
                                        <td>
                                            @if( $row->status == 1 )
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Append the "Select Title" option initially
        ...
        $('#year').on('change', function() {
            ...
            titleSelect.empty(); // Clear the existing options

            // Always keep the "Select Title" option
            titleSelect.append($('<option>', {
                value: '',
                text: 'Select Title'
            }));
