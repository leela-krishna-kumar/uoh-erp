                              ...
                              <div class="col-md-12">
                                <fieldset class="row scheduler-border">
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <input type="text" class="form-control" name="contact_person_name" id="contact_person_name" value="" >
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <input type="text" minlength="10" maxlength="10" class="form-control autonumber" name="contact_person_phone" value="">
