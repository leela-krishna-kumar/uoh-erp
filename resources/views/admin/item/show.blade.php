                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><mark class="text-primary">{{ __('field_inventory') }}:</mark> {{ $row->stocks->where('status', 1)->sum('quantity') - $row->issues->where('status', 0)->sum('quantity') }}</p><hr/>
                                ...
                                <p>
                                    <mark class="text-primary">{{ __('Type') }}:</mark>
