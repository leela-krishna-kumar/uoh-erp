            ...
            <div class="card-block">
              ...
              <div class="row" >
                ...
                @for ($i=0; $i<$graph_count-1 ;$i++)     
                  ...
                  <a style="padding:5px;" target="_blank" href="{{ url('/admin/exam/exam-result?faculty=1&program=11&session=21&semester=15&section=3&subject=162&type=12') }}" class="btn btn-success btn-filter">Tablular View</a>
...
function att0DrawChart() {
  ...
  var $present_count = '<?php echo rand(100,150); ?>';
  var $absent_count = '<?php echo rand(1,10); ?>';
