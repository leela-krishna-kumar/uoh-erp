            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Library Auto CheckIN CheckOUT</h5>
                    </div>
                        ...
                        <form class="needs-validation" novalidate method="get" action="{{ route($route.'.index') }}">
                            <div class="row gx-2">
                                <div class="form-group col-md-3">
                                    ...
                                    <input autofocus type="text" class="form-control" name="search_roll" id="search_roll" required value="">
                                ...
                                @endif
                                    ...
                                    <fieldset class="row gx-2 scheduler-border">
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="datetime-local" class="form-control" @if ($library_attendence_roll_latest != null && $library_attendence_roll_latest->out_time == null) value="{{ $library_attendence_roll_latest->in_time }}" readonly @else  value="@php echo \Carbon\Carbon::now(); @endphp" @endif name="in_time"  required>
                                            <div class="invalid-feedback">
                                                {{ __('required_field') }} {{ __('field_hostel') }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-5">
                                            ...
                                            <input type="datetime-local" readonly class="form-control" name="out_time" value="@php echo \Carbon\Carbon::now(); @endphp" required>
                                            <div class="invalid-feedback">
                                            {{ __('required_field') }} {{ __('field_hostel') }}
                                            </div>
                                        </div>
