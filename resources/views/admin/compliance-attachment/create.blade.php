                              ...
                              <div class="col-md-12">
                                <fieldset class="row scheduler-border">
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <input type="text" class="form-control" name="contact_person_name" id="contact_person_name" value="{{ old('contact_person_name') }}" >

                                      <div class="invalid-feedback"> {{ __('field_contact_person_name') }}
                                      </div>
                                  </div>

                                  <div class="form-group col-md-6">
                                      <label for="contact_person_phone">{{ __('field_contact_person_phone') }}</label>
                                      <input type="number" class="form-control" name="contact_person_phone" value="{{ old('contact_person_phone') }}">

                                      <div class="invalid-feedback">{{ __('field_contact_person_phone') }}
                                      </div>
                                  </div>
                                  <div class="form-group col-md-6">
