            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block d-flex justify-content-between">
                        <div>
                                @can($access.'-create')
                                <a href="{{ route($route.'.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('field_bulk_assign') }}</a>
                                @endcan

                                <a href="{{ route($route.'.index') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i> {{ __('btn_refresh') }}</a>
                        </div>
                        <div>
                                <a href="{{ route('admin.fees-student.quick.assign') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('field_quick_assign') }}</a>
                        </div>
                    </div>
                    ...
                    <div class="card-block">
                        <form class="needs-validation" novalidate method="get" action="{{ route($route.'.index') }}">
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="seat_type_id">{{ __('field_seat_type') }}</label>
