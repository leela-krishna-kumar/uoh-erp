                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($exam->contribution > 0)
                                                ...
                                                {{ $exam->type->title ?? '' }} - {{ round($exam->achieve_marks ?? '0', 2) }} ({{ $exam->type ? $exam->type->marks : '' }}) ({{ round($exam->contribution, 2) }} %)
                                                </span><br>
                                            @endif
                                            @endforeach
                                        </td>
...
@section('page_js')
    <script type="text/javascript">
        ...
        function marksCalculator(type, id) {
          ...
          if(assignments == ''){
            var total_marks = parseFloat(exam_marks) + parseFloat(attendances) + parseFloat(activities);
          }else{
