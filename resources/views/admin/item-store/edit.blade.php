              ...
              <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" name="phone" id="phone" value="{{ $row->phone }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" required class="form-control" name="email" id="email" value="{{ $row->email }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea required class="form-control" name="address" id="address">{{ $row->address }}</textarea>
