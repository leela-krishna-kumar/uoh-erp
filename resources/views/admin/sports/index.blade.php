                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="title" class="form-label">{{trans_choice('module_sports_Name',1) }} <span>*</span></label>
                                <input type="text" class="form-control" name="sports" id="sports" value="{{ old('sports') }}" required>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>#</th>
                                         <th></th>
                                         <th></th>
                                        <th>{{trans_choice('module_sports_Name',1) }}</th>
                                        <th></th>
                                        <th></th>
