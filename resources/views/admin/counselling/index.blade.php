                        ...
                        <form class="needs-validation" novalidate method="get" action="{{ route($route.'.index') }}">
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="counselling_category_id" id="counselling_category_id">
                                ...
                                <tbody>
                                  @foreach($rows as $key => $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->date}}</td>
                                        <td>
                                            <span class="badge badge-{{\App\Models\Counselling::STATUSES[$row->status]['color']}}">{{\App\Models\Counselling::STATUSES[$row->status]['label']}}</span>
                                        </td>

                                        <td>
                                            {{-- <a href="{{ route('admin.counselling.user-create', ['session_id' => $row->id]) }}" class="btn btn-icon btn-primary btn-sm" title="Assign User">
