                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                          <label for="name" class="form-label">{{ __('field_hostel_id') }} {{ __('field_hostel_id') }} <span>*</span></label>
                          <input type="text" class="form-control" name="hostel_id" id="hostel_id" value="{{ @$row->hostel_id }}" required>
                          <div class="invalid-feedback">
                            {{ __('required_field') }} {{ __('field_hostel_id') }} {{ __('field_hostel_id') }}
                          </div>
                      </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            <label for="occupancy" class="form-label">{{ __('field_occupancy') }}<span>*</span></label>
                            <input type="number" class="form-control" name="occupancy" id="occupancy" value="{{ $row->occupancy }}" required>
  
                            <div class="invalid-feedback">
                              {{ __('required_field') }}  {{ __('field_occupancy') }}
                            </div>
                        </div>

                        <div class="form-group col-md-4">
                            <div class="switch d-inline m-r-10">
                                <label>{{ __('Internet') }}</label>
                                <input type="checkbox" id="internet" name="internet" value="1" @if ($row->internet == 1) checked @endif>
                                <label for="internet" class="cr"></label>
                            </div>
                        </div>
