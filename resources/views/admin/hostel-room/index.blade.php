                            ...
                            <div class="row gx-2">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="room_type" id="room_type">
                                        <option value="">{{ __('select') }}</option>
                                        <option value="all" @if ($selected_room_type == 'all') selected @endif>{{ __('all') }}</option>
                                ...
                                <table id="export-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('field_type') }}</th>
                                            <th>{{ __('field_occupancy') }}</th>
                                            <th>{{ __('field_availability') }}</th>
                                            {{-- <th>{{ __('field_fee') }}</th> --}}
                                    ...
                                    @foreach( $rows as $key => $row )
                                        <tr>
                                            ...
                                            <td>{{ $row->occupancy - $row->hostelMembers->where('status', '1')->count() }}</td>
