                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p><mark class="text-primary">{{ __('field_occupancy') }}:</mark> {{ $row->occupancy }}</p><hr/>
                                <p><mark class="text-primary">{{ __('field_availability') }}:</mark> {{ $row->occupancy - $row->hostelMembers->where('status', '1')->count() }}</p><hr/>
