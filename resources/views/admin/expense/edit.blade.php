                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="status" id="status">
                                <option value="1" @if( $row->status == 1 ) selected @endif>{{ __('status_paid') }}</option>
                                <option value="0" @if( $row->status == 0 ) selected @endif>{{ __('status_unpaid') }}</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="department_id" id="department_id" required>
                                ...
                                <option value="{{ $department->id }}" @if( $department->id == $row->department_id ) selected @endif>{{ $department->title }}</option>
                                @endforeach
                            </select>
