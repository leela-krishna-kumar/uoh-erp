                    ...
                    <div class="card-block">
                        ...
                        <fieldset class="row scheduler-border">
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="to_acc_no" id="to_acc_no" value="{{ $row->to_acc_no }}" required>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="subject_id" id="subject_id" required>
                                ...
                                <option value="{{ $subject->id }}" @if($row->subject_id == $subject->id) selected @endif>{{ $subject->subject }}</option>
                                @endforeach
                            </select>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="no_of_pages" id="no_of_pages" value="{{ $row->no_of_pages }}">
