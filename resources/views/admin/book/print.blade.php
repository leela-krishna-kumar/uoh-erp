...
<div class="template-container printable">
  <div class="template-inner">
    ...
    <table class="table-no-border top-meta-table">
        <tbody>
            <tr>
                <td class="meta-data">{{ __('field_rack_no') }}</td>
                <td class="meta-data value">: {{ $row->rack_no }}</td>
                <td class="meta-data">{{ __('field_sub_rack_no') }}</td>
                <td class="meta-data value">: {{ $row->sub_rack_no }}</td>
            </tr>
        </tbody>
    </table>
    <!-- Header Section -->
