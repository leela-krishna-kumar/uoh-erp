                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                <label for="title" class="form-label">{{trans_choice('module_holiday_title',1) }} <span>*</span></label>
                                <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" required>

                            </div>
                            <div class="form-group">
                                <label for="date" class="form-label">{{trans_choice('module_holiday_date',1) }} <span>*</span></label>
                                <input type="date" class="form-control" name="date" id="date_id" value="{{ old('date') }}" required>
                            ...
                            <div class="form-group">
                                <label for="description" class="form-label"> {{trans_choice('module_holiday_description',1) }}</label>
                        ...
                        <div class="table-responsive">
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{trans_choice('module_holiday_title',1) }}</th>
                                        <th>{{trans_choice('module_holiday_date',1) }}</th>
                                        <th>{{trans_choice('module_holiday_description',1) }}</th>
