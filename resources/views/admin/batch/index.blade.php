                        ...
                        <div class="card-block">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <div class="checkbox d-inline">
                                    ...
                                    <label for="program-{{ $key }}" class="cr">
                                        {{ $program->faculty->title }} / {{ $program->shortcode }}</label>
                                </div>
                                @endforeach
                                        ...
                                        <td class="width-20">
                                            <div class="white-space-normal">
                                                @foreach($row->programs as $key => $program)
                                                    <span class="badge badge-primary">{{ $program->shortcode }}</span>
                                                @endforeach
                                            </div>
                                        </td>
                                        <td>{{ @$row->regulation->name }}</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        @if(session('openModal'))
            // Delay opening the modal by 100 milliseconds (adjust the timing as needed).
            setTimeout(function() {
                var batchId = {{ $batch->id }}; // Replace with the actual batch ID.
                if (batchId) {
                    $('#editModal-' + batchId).modal('show');
                }
            }, 1000);
        @endif
    });
