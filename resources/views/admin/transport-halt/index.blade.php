    ...
    <div class="page-wrapper">
        ...
        <div class="row">
                ...
                <input type="hidden" name="route_id" value="{{request()->route_id}}">
                    <div class="card">
                        <div class="card-header">
                            <h5>{{ __('btn_create') }} {{@$transportRoute->title}} {{ $title }}</h5>
                        </div>
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <textarea class="form-control" name="name" id="name" value="{{ old('name') }}" required></textarea> -->
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5>{{@$transportRoute->title}} {{ $title }} {{ __('list') }}</h5>
                    </div>
                    <div class="card-block">
                        <!-- [ Data table ] start -->
                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('field_name') }}</th>
                                        <th>{{ __('field_latitude') }}</th>
                                        <th>{{ __('field_longitude') }}</th>
