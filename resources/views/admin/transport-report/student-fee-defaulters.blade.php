            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form class="needs-validation" novalidate method="get" action="{{ route('admin.transport.student-fee-defaulters') }}">
                            <div class="row gx-2">
                                ...
                                <tbody>
                                  ...
                                  @foreach( $rows as $key => $row )
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ number_format((float)getStudentFeeByType($row,'Transportation',request()->category)['remaining_fee'], 2, '.', '') }} </td>
                                        <td>
