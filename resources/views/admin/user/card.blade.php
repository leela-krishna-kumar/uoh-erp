...
<div class="template-container printable">
  <div class="template-inner">
    ...
    <table class="table-no-border">
        <tbody>
            <tr class="meta-data">
                <td>{{ __('field_staff_id') }}</td>
                <td class="value">: {{ $row->staff_id }}</td>
            </tr>
            <tr class="meta-data">
                <td>{{ __('field_name') }}</td>
            ...
            <tr class="meta-data">
                <td>{{ __('field_designation') }}</td>
                <td class="value">: {{ $row->designation->title ?? $row->designation->title }}</td>
            </tr>
            <tr class="meta-data">
                <td>{{ __('field_department') }}</td>
                <td class="value">: {{ $row->department->title ?? $row->department->title }}</td>
            </tr>
            <tr class="meta-data">
