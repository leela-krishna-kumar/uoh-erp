                ...
                <div class="col-md-12">
                  <fieldset class="row scheduler-border">
                   ...
                   <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      <label for="email">{{ __('field_secondary_email') }} <span>*</span></label>
                      <input type="email" class="form-control" name="secondary_email" id="email" value="{{ $row->secondary_email }}" required>
