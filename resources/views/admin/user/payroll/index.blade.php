<form class="needs-validation mt-3" novalidate action="{{ route('admin.update-payroll',$row->id) }}" method="post">
  ...
  <fieldset class="row scheduler-border">
    ...
    <div class="form-group col-md-4">
       ...
       <input type="text" class="form-control autonumber" name="basic_salary" id="basic_salary" value="{{ @$row->basic_salary }}" readonly>
       <div class="invalid-feedback">
    ...
    <div class="form-group col-md-4">
       ...
       <input type="text" class="form-control" name="epf_no" id="epf_no" value="{{ $row->epf_no }}" readonly>
       <div class="invalid-feedback">
