                        ...
                        <div class="table-responsive">
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th class="pl-2">{{ __('field_column_id') }}</th>
                                ...
                                <tbody>
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.transport-halt.index',['route_id' =>$row->id]) }}" class="btn btn-icon btn-success btn-sm" title="Assign User">
