...
<link rel="stylesheet" href="{{ asset('dashboard/css/style.css') }}" type="text/css" media="screen, print">     
                    ...
                    <div class="messages-headline">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="edit-user mb-1" style="display: inherit;margin-left: 10px;">
                                ...
                                {{-- <button title="add user" id="add_user" type="button" class="btn btn-primary">Compose</button> --}}
    ...
    <div id="composeModal" uk-modal>
        <div class="uk-modal-dialog">
            ...
            </div><div class="uk-modal-footer text-right">
            ...
            if(role_id == 0){
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if(res){
                            $('#user_container').show();
                            result = $('#chat_user').html(res).css('width','100%');
                        }
                    }
