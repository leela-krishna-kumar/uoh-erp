                        ...
                        <div class="table-responsive">
                            <table class="display table nowrap table-striped table-hover" style="width:100%">
                                ...
                                @if($row->assignment->status == 1)
                                    <tr>
                                        <td>
                                            <a href="{{ route('student.assignment.show', $row->id) }}">{{ $row->assignment->title ?? '' }}</a>
                                        </td>
                                  ...
                                  @if($key < 10)
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a class="media" href="{{ route($notification_link) }}">{{ $notification->data['title'] }}</a><span>{{ $notification->created_at->diffForHumans() }}</span>
                                            @else
                                            <a class="media" href="{{ route($notification_link, $notification->data['id']) }}">{{ $notification->data['title'] }}</a><span>{{ $notification->created_at->diffForHumans() }}</span>
                                            @endif
                                        </td>
