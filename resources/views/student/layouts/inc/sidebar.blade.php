...
<div class="navbar-content scroll-div ps ps--active-y">
    <ul class="nav pcoded-inner-navbar">
        ...
        <li class="nav-item {{ Request::is('student/leave*') ? 'active' : '' }}">
         ...
         <li class="nav-item {{ Request::is('student/approval-submissions*') ? 'active' : '' }}">
            <a href="{{ route('student.approval-submissions.index') }}" class="nav-link">
                <span class="pcoded-micon"><i class="far fa-edit"></i></span>
                <span class="pcoded-mtext">{{ trans_choice('module_approval_submissions', 2) }}</span>
            </a>
        </li>
        ...
        <li class="nav-item {{ Request::is('student/check-bus*') ? 'active' : '' }}">
            <a href="{{ route('student.check-bus.index') }}" class="nav-link">
                <span class="pcoded-micon"><i class="fa fa-bus"></i></span>
                <span class="pcoded-mtext">{{ trans_choice('module_check_my_bus', 1) }}</span>
            </a>
        </li>
