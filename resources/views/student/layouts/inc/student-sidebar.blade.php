...
<div class="sidebar">
    <div class="sidebar_inner" data-simplebar>
        ...
        <ul class="side_links" data-sub-title="Pages">
            ...
            <li class="nav-item {{ Request::is('student/student-check-my-bus*') ? 'active' : '' }}">
                <a href="{{route('student.check-bus.index')}}"> <span name="" class="side-icon uil-bus"></span> Check My Bus </a>
            </li> 
            <li class="nav-item {{ Request::is('student/yearbook*') ? 'active' : '' }}">
                <a href="{{route('student.yearbook.index')}}"> <span name="" class="side-icon uil-bus"></span> YearBook </a>
            </li> 
            <li class="nav-item {{ Request::is('student/placements*') ? 'active' : '' }}">
                <a href="{{route('student.placements.index')}}"> <span name="" class="side-icon uil-bus"></span> Placements </a>
            </li> 
