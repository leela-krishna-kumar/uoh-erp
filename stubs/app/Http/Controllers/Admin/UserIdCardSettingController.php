...
use Toastr;
class UserIdCardSettingController extends Controller
{
    use FileUploader;
    ...
    public function __construct()
    {
        ...
        $this->route = 'admin.user.id-card-setting';
        $this->view = 'admin.user.id-card-setting';
    ...
    public function index()
    {
        ...
        $data['row'] = IdCardSetting::where('slug', 'user-card')->first();
