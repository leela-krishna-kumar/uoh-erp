                            ...
                            <table id="basic-table" class="display table nowrap table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>{{ __('field_name') }}</th>
                                        <th>{{ __('field_contact_person_name') }}</th>
                                        <th>{{ __('field_contact_person_phone') }}</th>
                                ...
                                <tbody>
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-{{ App\Models\Company::STATUSES[$row->status]['color'] }}">{{ App\Models\Company::STATUSES[$row->status]['label'] }}</span>
                                        </td>
                                        <td>
                                            @can($access.'-edit')
