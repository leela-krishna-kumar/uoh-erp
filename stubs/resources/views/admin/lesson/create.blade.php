                              ...
                              <div class="col-md-12">
                                <fieldset class="row scheduler-border">
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <select class="form-control" name="subject_id" id="subject_id"required>
                                        ...
                                        @foreach ($subjects as $key => $subject)
                                            <option value="{{$key}}" @if( $key == 0) selected @endif>{{ $subject->title }}</option>
                                        @endforeach
                                    </select>
                                      <div class="invalid-feedback">
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <input type="date" class="form-control" name="start_date" id="start_date" value="{{now()->format('Y-m-d')}}" >

                                      <div class="invalid-feedback"> {{ __('field_start_date') }}
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group col-md-6">
                                      ...
                                      <div class="invalid-feedback">{{ __('field_end_date') }}
                                      </div>
                                  </div>
                                  <div class="form-group col-md-6">
