                        ...
                        <content class="form-step">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="month" class="form-control" name="academic_year_from" id="academic_year_from" value="{{ $row->academic_year_from}}" required>
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select class="form-control select2" name="managed_by[]" id="managed_by"multiple required>
                                  @foreach($teachers as $key => $teacher)
                                    <option value="{{$teacher->id}}" @if($row->managed_by == $teacher->id) selected @endif>{{ $teacher->first_name }} {{ $teacher->last_name }}</option>
                                  @endforeach
                              </select>
