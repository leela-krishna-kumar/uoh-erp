    ...
    $(".faculty").on('change',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.program').append('<option value="all">{{ __("All") }}</option>');
    ...
    $(".program").on('change',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.session').append('<option value="all">{{ __("All") }}</option>');
            $.each(response, function(){
              $('<option/>', {
                'value': this.id,
                'text': this.title
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.semester').append('<option value="all">{{ __("All") }}</option>');
            $.each(response, function(){
              $('<option/>', {
                'value': this.id,
                'text': this.title
    ...
    $(".semester").on('change',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.section').append('<option value="all">{{ __("All") }}</option>');
            $.each(response, function(){
              $('<option/>', {
                'value': this.id,
                'text': this.title
    ...
    $(".session").on('change',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
            ...
            $('.subject').append('<option value="all">{{ __("ALL") }}</option>');
            $.each(response, function(){
              $('<option/>', {
                'value': this.id,
